...
//Customer View
  addTicket(ticket: any) {
    ...
    return this.http.post<Common>(`http://localhost:8080/ticket/addticket/${userId}`, ticket)
  }
  ...
  getCustomerTicketDetails() {
    ...
    const decryptedData = CryptoJS.AES.decrypt(encryptedData1, secretKey).toString(CryptoJS.enc.Utf8);
    const userId = parseInt(decryptedData, 10);
    return this.http.get<Common>(`http://localhost:8080/customer/getCustomerTicketDetails/${userId}`)
  }
  ...
  getTicket() {
    ...
    return this.http.get<Common>(`http://localhost:8080/agents/categorytickets/${agentId}`)
  }
  ...
  getFilteredTickets(filter:any){
    ...
    const decryptedData = CryptoJS.AES.decrypt(encryptedData1, secretKey).toString(CryptoJS.enc.Utf8);
    const agentId = parseInt(decryptedData, 10);
    return this.http.post<Common>(`http://localhost:8080/agents/getfilteredtickets/${agentId}`,filter)
  }
  ...
  closeTicketss() {
    ...
    const decryptedData = CryptoJS.AES.decrypt(encryptedData1, secretKey).toString(CryptoJS.enc.Utf8);
    const agentId = parseInt(decryptedData, 10);
    return this.http.put<Common>(`http://localhost:8080/agents/${custTicketId}/closedticket/${agentId}`, { responseType: 'text' })
  }
...
// Agent
  getAgentList() {
    ...
    const decryptedData = CryptoJS.AES.decrypt(encryptedData1, secretKey).toString(CryptoJS.enc.Utf8);
    const userId = parseInt(decryptedData, 10);
    return this.http.get<Common>(`http://localhost:8080/agents/agentsCategory/${userId}`)
  }
  ...
  getAssiginedTickets() {
    ...
    const decryptedData = CryptoJS.AES.decrypt(encryptedData1, secretKey).toString(CryptoJS.enc.Utf8);
    const agentId = parseInt(decryptedData, 10);
    return this.http.get<Common>(`http://localhost:8080/agents/assignedTickets/${agentId}`)
  }
...
// Customer View
  ...
  getCustomerSearchTickets(search: SearchCriteria){
    ...
    const userId = parseInt(decryptedData, 10);
    // this.customerTicket
    return this.http.post<Common>(`http://localhost:8080/customer/search/${userId}`,search)
  ...
  getSearch(search: SearchCriteria) {
    ...
    const agentId = parseInt(decryptedData, 10);
    //  this.agentId
    return this.http.post<Common>(`http://localhost:8080/agents/search/${agentId}`, search)
  }
  ...
  getCustomerFilterTickets(filter: any) {
    ...
    return this.http.post<Common>(`http://localhost:8080/customer/filtercustomertickets/${customerId}`, filter)
  }
  ...
  getChatMessage(chat: Chat) {
    ...
    return this.http.post<Common>(`http://localhost:8080/comment/addcomments/${agentId}/${agentTicket}`, chat)
  }
  ...
  setCustomerChat(chats: Chat) {
    ...
    return this.http.post<Common>(`http://localhost:8080/comment/addcustomercomments/${customerId}/${acustomerTicketId}`, chats)
  }
  // Customer View
