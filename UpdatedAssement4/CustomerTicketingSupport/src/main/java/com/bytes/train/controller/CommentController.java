...
public class CommentController {
	...
	public ResponseEntity<Response> addAgentComment(@PathVariable String agentId, @PathVariable int ticketId,
		...
		try {
			...
			Comment comment2 = commentService.setComment(originalId, ticketId, comment);
			if (comment2 == null) {
	...
	public ResponseEntity<Response> addCustomerComment(@PathVariable String customerId, @PathVariable int ticketId,
			@RequestBody Comment comment) {
		try {
			...
			Comment customerComment = commentService.setCustomerComments(originalId, ticketId, comment);
