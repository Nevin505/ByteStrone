...
//	Search Jpa's
	...
	List<Ticket> findByCategoryIdInAndStatusAndSubjectIgnoreCaseContainingOrCategoryIdInAndTicketIdAndStatus(List<Category> category, String status,String subject,List<Category> category1,int ticketId,String status1);
...
//	List<Ticket> findAllByCategoryIdInAndStatusInAndAndSubjectIgnoreCaseContainingOrTicketId(List<Category> category, String[] status,String subject,int ticketId);
	...
	List<Ticket> findAllByCategoryIdInAndStatusInAndAndSubjectIgnoreCaseContainingOrCategoryIdInAndStatusInAndTicketId(List<Category> category, String[] status,String subject,List<Category> category1,String[] statuss,int ticketId);
...
//	Customer Search JPA Query
	...
	List<Ticket> findByStatusAndCustomerAndSubjectIgnoreCaseContainingOrCustomerAndTicketIdAndStatus(String status,Customer cutsomer,String subject,Customer cutsomer1,int ticketId,String searchStatus);
