...
//Positive Test Case  
	...
	void testGetParticularCategoryList() throws Exception {
		...
		ticket1.setStatus(StatusEnum.Open);
		...
		ticket2.setStatus(StatusEnum.Open);
...
//	Negative Test Case
	...
	public void testGetAssignedTickets() throws Exception {
		...
		when(ticketRepository.findByAgentIdAndStatus(eq(agent), eq(StatusEnum.Assigned))).thenReturn(assignedTickets);
