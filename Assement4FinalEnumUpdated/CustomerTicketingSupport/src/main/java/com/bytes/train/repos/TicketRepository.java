...
//	status
	...
	List<Ticket> findByAgentIdAndStatus(Agent agent, StatusEnum status);
	...
	List<Ticket> findAllByCategoryIdInAndStatusIn(List<Category> ids, StatusEnum[] Status);
	...
	List<Ticket> findAllByCategoryIdInAndStatus(List<Category> category, StatusEnum status);
...
//	Search Jpa's
	List<Ticket> findByCategoryIdInAndStatusAndTicketId(List<Category> category, StatusEnum status,int ticketId);
	
	List<Ticket> findByCategoryIdInAndStatusAndSubjectIgnoreCaseContaining(List<Category> category, StatusEnum status,String subject);
	
	List<Ticket> findAllByCategoryIdInAndStatusInAndAndTicketId(List<Category> category,StatusEnum[] Status,int ticketId);
	...
	List<Ticket> findByCategoryIdInAndStatusAndSubjectIgnoreCaseContainingOrCategoryIdInAndTicketIdAndStatus(List<Category> category, StatusEnum status,String subject,List<Category> category1,int ticketId,StatusEnum status1);
	
	List<Ticket> findAllByCategoryIdInAndStatusInAndAndSubjectIgnoreCaseContaining(List<Category> category, StatusEnum[] status,String subject);
...
//	List<Ticket> findAllByCategoryIdInAndStatusInAndAndSubjectIgnoreCaseContainingOrTicketId(List<Category> category, String[] status,String subject,int ticketId);
	...
	List<Ticket> findAllByCategoryIdInAndStatusInAndAndSubjectIgnoreCaseContainingOrCategoryIdInAndStatusInAndTicketId(List<Category> category, StatusEnum[] status,String subject,List<Category> category1,StatusEnum[] statuss,int ticketId);
...
//
	...
	List<Ticket> findByCustomer_idAndStatus(int cutsomerId, StatusEnum status);

	List<Ticket> findByStatus(StatusEnum status);
...
//	Customer Search JPA Query
	List<Ticket> findByStatusAndCustomerAndTicketId(StatusEnum status,Customer cutsomer,int ticketId);
	
	List<Ticket> findByStatusAndCustomerAndSubjectIgnoreCaseContaining(StatusEnum status,Customer cutsomer,String subject);
	...
	List<Ticket> findByStatusAndCustomerAndSubjectIgnoreCaseContainingOrCustomerAndTicketIdAndStatus(StatusEnum status,Customer cutsomer,String subject,Customer cutsomer1,int ticketId,StatusEnum searchStatus);
	...
	List<Ticket> findByCustomerAndSubjectIgnoreCaseContainingOrCustomerAndTicketId(Customer cutsomer,String subject,Customer cutsomer1,int ticketId);
