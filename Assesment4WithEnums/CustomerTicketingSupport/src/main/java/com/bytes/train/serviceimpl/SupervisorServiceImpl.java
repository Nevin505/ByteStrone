...
public class SupervisorServiceImpl implements SupervisorService {
	...
	public Map<String, Integer> getSolvedUnsolvedTickets() {
		...
		int openTickets = (ticketRepository.findByStatus(StatusEnum.Open)).size();
		int assiginedTickets = (ticketRepository.findByStatus(StatusEnum.Assigned)).size();
		int solvedTickets = (ticketRepository.findByStatus(StatusEnum.Closed)).size();
