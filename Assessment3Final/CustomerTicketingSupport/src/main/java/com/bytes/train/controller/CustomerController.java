...
//		Customer Closed,Assigned And Open Tickets Filter
	...
	public ResponseEntity<Response> getOpenTickets(@PathVariable("cutsomerId") int customerId,
	...
	public ResponseEntity<Response> searchTickets(@PathVariable("customerId") int customerId,
			@RequestBody SearchCriteria searchCriteria) {
		try {
			List<Ticket> searchTickets = customerService.getSearch(customerId, searchCriteria);
