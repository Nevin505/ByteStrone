...
export class AgentViewComponent {
  ...
  getTicketDetails() {
    ...
    this.api.getTicket().subscribe(res => {
      this.data = res;
      this.lengthsearch=this.data.length;
      this.cate = this.api.agentCategoryGetter();
      console.log(this.data);
    })
  }
  ...
  filterByStatus(Status: String) {
    ...
    if (this.currentStaus === 'Open') {
      this.api.getOpenTicke().subscribe(res => {
        this.data = res;
        this.lengthsearch=this.data.length; 
      })
    }
    else if (this.currentStaus == 'Closed') {
      this.api.getCloseFullTickets().subscribe(res => {
        this.data = res;
        console.log(this.data);
  ...
  searchTicket(){
    ...
    this.api.getSearch(this.search).subscribe((res)=>{
      console.log(res);
      this.data=res;
      this.lengthsearch=this.data.length; 
    })
